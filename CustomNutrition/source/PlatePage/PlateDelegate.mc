...
class PlatePageDelegate extends WatchUi.BehaviorDelegate {
    ...
    var recipeMenu;     // Recipe selection instance of Menu2
    ...
    function onNextPage() {
        ...
        recipeMenu.addItem(
            new WatchUi.MenuItem(Rez.Strings.meal_option1,
                                 null,
                                 "breakfast",
                                 {}
                                 )
        ...
        recipeMenu.addItem(
            new WatchUi.MenuItem(Rez.Strings.meal_option2,
                                 null,
                                 "lunch",
                                 {}
                                 )
        ...
        recipeMenu.addItem(
            new WatchUi.MenuItem(Rez.Strings.meal_option3,
                                 null,
                                 "snack",
                                 {}
                                 )
